...
const Footer = () => {
  ...
  return (
    <footer className={styles.footer}>
      <nav>
        <Link href='/' active={(router.pathname === '/').toString()}>
          <svg
            width='24'
            height='24'
        ...
        <Link href='/lists' active={(router.pathname === '/lists').toString()}>
          <svg
            width='24'
            height='24'
            xmlns='http://www.w3.org/2000/svg'
        ...
        <Link
          href='/search'
          active={(router.pathname === '/search').toString()}>
          <svg
            width='24'
            height='24'
            xmlns='http://www.w3.org/2000/svg'
        ...
        <Link
          href='/up-next'
          active={(router.pathname === '/up-next').toString()}>
          <svg
            width='24'
            height='24'
            xmlns='http://www.w3.org/2000/svg'
        ...
        <Link
          href='/account'
          active={(router.pathname === '/account').toString()}>
          <svg
            width='24'
            height='24'
            xmlns='http://www.w3.org/2000/svg'
